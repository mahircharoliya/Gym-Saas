...
export default function TeamPage() {
    ...
    return (
        <div className="max-w-2xl space-y-6">
            <div>
                <h2 className="text-lg font-semibold text-white">Team & Invites</h2>
                <p className="text-sm text-gray-400 mt-1">Invite staff members to your gym.</p>
            </div>

            {/* Invite form */}
            <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
                <p className="text-sm font-medium text-white mb-4">Send Invite</p>
            ...
            {/* Pending invites */}
            <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
                <p className="text-sm font-medium text-white mb-4">Pending Invites</p>
                {invites.length === 0 ? (
